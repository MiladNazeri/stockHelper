...
var api = {
    ...
    companies(){
        ...
        return axios.get("http://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20yahoo.finance.industry&format=json&env=store%3A%2F%2Fdatatables.org%2Falltableswithkeys")
    }
}
